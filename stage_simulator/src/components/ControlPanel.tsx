        ...
        <div className="w-80 bg-gray-800 text-white p-4 overflow-y-auto">
            ...
            <div className="mb-6">
                ...
                <div className="space-y-3">
                    <div>
                        <label htmlFor="ambient-intensity" className="block text-sm font-medium mb-1">環境光の強度</label>
                        <input
                            ...
                            onChange={(e) => onAmbientIntensityChange(Number.parseFloat(e.target.value))}
                            className="w-full"
                        />
                        <span className="text-xs text-gray-400">{ambientIntensity.toFixed(1)}</span>
                    </div>
                    <div>
                        <label htmlFor="main-light-intensity" className="block text-sm font-medium mb-1">メイン光源の強度</label>
                        <input
                            ...
                            onChange={(e) => onMainLightIntensityChange(Number.parseFloat(e.target.value))}
                            className="w-full"
                        />
                        <span className="text-xs text-gray-400">{mainLightIntensity.toFixed(1)}</span>
                    </div>
                    <div>
                        <label htmlFor="fill-light-intensity" className="block text-sm font-medium mb-1">補助光源の強度</label>
                        <input
                            ...
                            onChange={(e) => onFillLightIntensityChange(Number.parseFloat(e.target.value))}
                            className="w-full"
                        />
                        <span className="text-xs text-gray-400">{fillLightIntensity.toFixed(1)}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-6">
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        <label htmlFor="fov" className="block text-sm font-medium mb-1">視野角 (FOV)</label>
                        <input
                            id="fov"
                            type="range"
                            min="10"
